...
The mesh CA must be generated and stored in SSM before deploying any cluster. See [docs/runbooks/istio-mesh-ca-bootstrap.md](../../docs/runbooks/istio-mesh-ca-bootstrap.md).
