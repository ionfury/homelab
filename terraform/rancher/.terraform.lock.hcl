...
provider "registry.terraform.io/rancher/rke" {
  version     = "1.4.2"
  constraints = ">= 1.4.1, 1.4.2"
  hashes = [
    "h1:23xICskz2oSojr9cG1r0FDVZTopBxVEegUFwbJEV1is=",
    "h1:caO/sw6Ow3nD5jh2PoXYKFHPYl4LvWk04otQoMgUolQ=",
